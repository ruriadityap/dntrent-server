...
describe("API ENDPOINT TESTING", () => {
  it("GET Landing Page", (done) => {
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body.hero).to.have.all.keys("hotels", "villas", "cities");
        expect(res.body).to.have.property("PopulerMinat");
        expect(res.body.PopulerMinat).to.have.an("array");
  ...
  it("GET Detail Page", (done) => {
    chai
      .request(app)
      .get("/api/v1/member/detail-page/62a84f5a17d2d51104202197")
      .end((err, res) => {
        expect(err).to.be.null;
        expect(res).to.have.status(200);
        expect(res.body).to.be.an("object");
        expect(res.body).to.have.property("contry");
  ...
  it("POST Booking Page", (done) => {
    ...
    const dataSample = {
      image,
      idItem: "62a84f5a17d2d51104202197",
      duration: 2,
